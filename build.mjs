#!/usr/bin/env node
// build.mjs — assemble dist/chromium/ from manifest.json + src/.
//
// Copies src/ verbatim into dist/chromium/ and drops manifest.json at its root.
// With --zip, also writes the store-upload bundle dist/chromium.zip (manifest
// at the zip root, as the Chrome Web Store expects).
//
// Usage:
//   node build.mjs           # build dist/chromium/
//   node build.mjs --zip     # build, then also write dist/chromium.zip
//
